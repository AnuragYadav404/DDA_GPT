...
class GPTConfig:
    ...
    batch_size: int = 12            # batch_size is: number of sequences we process in parallel
    n_embd: int = 768               # n_embd is attention blocks dimensions
...
# i think we need to do a inital config call?
...
if ddp:
    ...
    print("DDP is being used")
else:
    # vanilla, non-DDP run
    print("vanilla, non-DDP run")
    ddp_rank = 0
    ddp_local_rank = 0
    ddp_world_size = 1
    master_process = True
